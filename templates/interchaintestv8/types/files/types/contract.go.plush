...
// E is the execute message type
// Q is the query message type
func Instantiate[I, E, Q any](ctx context.Context, callerKeyName, codeId, admin string, chain *cosmos.CosmosChain, msg I, extraExecTxArgs ...string) (*Contract[I, E, Q], error) {
	isNoAdmin := admin == ""
	if !isNoAdmin {
